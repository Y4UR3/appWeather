        ...
        <article className='weather_info'>
            ...
            <ul className='weather_list'>
                <li className='weather_item'>
                    <span className='weather_label'>Wind Speed: </span><span className='weather_value'>{weather?.wind.speed}m/s</span></li>
                <li className='weather_item'>
                    <span className='weather_label'>Clouds: </span><span className='weather_value'>{weather?.clouds.all}%</span></li>
